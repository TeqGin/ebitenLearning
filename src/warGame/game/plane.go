...
func (p *plane) update(cfg *config) {
	...
	if ebiten.IsKeyPressed(ebiten.KeySpace) &&
		...
		bullet := loadBullet("resource/war/airplane/bullet/bullet1.png", cfg, p, 6, 0.2, false, false)
		p.bullets[bullet] = struct{}{}
		bullet = loadBullet("resource/war/airplane/bullet/bullet1.png", cfg, p, 6, 0.2, true, false)
		p.bullets[bullet] = struct{}{}
		bullet = loadBullet("resource/war/airplane/bullet/bullet1.png", cfg, p, 6, 0.2, true, true)
		p.bullets[bullet] = struct{}{}
